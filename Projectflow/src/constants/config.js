...
// ── Icônes des pièces jointes par type MIME
...
export const ACCOUNTS_STORAGE_KEY = "projectflow-accounts-v1";

// ── Intervalle de polling en millisecondes (synchro temps réel)
