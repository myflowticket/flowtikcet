...
// ── Les 5 rôles disponibles (combinables sur un même profil) export const ROLES = {
...
// ── Écrans accessibles (restrictibles par profil) export const SCREENS = {
...
// ── Permissions attribuées automatiquement par rôle export const DEFAULT_PERMISSIONS = {
...
// ── Profils utilisateurs par défaut (Alice = admin) export const DEFAULT_USER_PROFILES = {
